 ...
 * <p>
 */
public interface BlipSoundProvider extends SoundDevice {
    ...
    class BlipSoundProviderImpl implements BlipSoundProvider {
        ...
        public BlipSoundProviderImpl(String name, Region region, AudioFormat af, double clockRate) {
