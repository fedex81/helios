 ...
 */
@Deprecated
public class Ym2612NukeLegacy implements MdFmProvider {
    ...
    private static final Logger LOG = LogManager.getLogger(Ym2612NukeLegacy.class.getSimpleName());
    ...
    private Ym2612NukeLegacy(IYm3438.IYm3438_Type chip) {
    ...
    public Ym2612NukeLegacy(int bufferSize) {
