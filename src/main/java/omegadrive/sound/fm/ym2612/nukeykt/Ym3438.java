...
public class Ym3438 implements IYm3438 {
    ...
    /* logsin table */
    /* 16 bit unsigned - [256]*/
    static final int[] logsinrom = new int[]{
    ...
    /* exp table */
    static final  /* 16 bit unsigned - [256]*/ int[] exprom = new int[]{
    ...
    /* Note table */
    static final  /* 32 bit unsigned - [16]*/ int[] fn_note = new int[]{
            0, 0, 0, 0, 0, 0, 0, 1, 2, 3, 3, 3, 3, 3, 3, 3
    };

    /* Envelope generator */
    static final  /* 32 bit unsigned  - [4][4]*/ int[][] eg_stephi = new int[][]{
            {0, 0, 0, 0},
            {1, 0, 0, 0},
            {1, 0, 1, 0},
            {1, 1, 1, 0}
    ...
    static final  /* 8 bit unsigned - [4]*/ int[] eg_am_shift = new int[]{
            7, 3, 1, 0
    };

    /* Phase generator */
    static final  /* 32 bit unsigned - [8]*/ int[] pg_detune = new int[]{16, 17, 19, 20, 22, 24, 27, 29};

    static final  /* 32 bit unsigned - [8][8]*/ int[][] pg_lfo_sh1 = new int[][]{
            {7, 7, 7, 7, 7, 7, 7, 7},
            {7, 7, 7, 7, 7, 7, 7, 7},
            {7, 7, 7, 7, 7, 7, 1, 1},
            {7, 7, 7, 7, 1, 1, 1, 1},
    ...
    static final  /* 32 bit unsigned - [8][8]*/ int[][] pg_lfo_sh2 = new int[][]{
            {7, 7, 7, 7, 7, 7, 7, 7},
            {7, 7, 7, 7, 2, 2, 2, 2},
            {7, 7, 7, 2, 2, 2, 7, 7},
            {7, 7, 2, 2, 7, 7, 2, 2},
    ...
    /* Address decoder */
    static final  /* 32 bit unsigned  - [12]*/ int[] op_offset = new int[]{
            0x000, /* Ch1 OP1/OP2 */
            0x001, /* Ch2 OP1/OP2 */
            0x002, /* Ch3 OP1/OP2 */
            0x100, /* Ch4 OP1/OP2 */
    ...
    static final  /* 32 bit unsigned - [6]*/ int[] ch_offset = new int[]{
            0x000, /* Ch1 */
            0x001, /* Ch2 */
            0x002, /* Ch3 */
            0x100, /* Ch4 */
    ...
    /* LFO */
    static final  /* 32 bit unsigned - [8]*/ int[] lfo_cycles = new int[]{
            108, 77, 71, 67, 62, 44, 8, 5
    };

    /* FM algorithm */
    static final  /* 32 bit unsigned - [4][6][8]  */ int[][][] fm_algorithm = new int[][][]{
            {
            ...
            if (chip.write_d_en && (chip.write_data & 0x100) == 0) {
                switch (chip.write_fm_mode_a) {
                    ...
                    case 0x27: /* CSM, Timer control */
                        ...
                        chip.timer_a_enable = ((chip.write_data >> 2) & 0x01) == 1;
                        chip.timer_a_reset = ((chip.write_data >> 4) & 0x01) == 1;
                        chip.timer_b_load = ((chip.write_data >> 1) & 0x01) == 1;
...
//            sum = block + 9 + ((dt_l == 3) | (dt_l & 0x02));
    ...
    void OPN2_ChOutput(IYm3438.IYm3438_Type chip) {
        ...
        if ((chip_type & ym3438_mode_ym2612) > 0) {
            ...
            if (chip.ch_lock_l > 0 && out_en) {
                chip.mol = out;
            } else {
                chip.mol = sign;
            }
            if (chip.ch_lock_r > 0 && out_en) {
                chip.mor = out;
            } else {
                chip.mor = sign;
            }
    ...
    void OPN2_DoTimerA(IYm3438.IYm3438_Type chip) {
        ...
        if (chip.timer_a_reset) {
            ...
            chip.timer_a_overflow_flag |= chip.timer_a_overflow > 0 & chip.timer_a_enable;
        }
    ...
    void OPN2_DoTimerB(IYm3438.IYm3438_Type chip) {
        ...
        if (chip.timer_b_reset) {
            ...
            chip.timer_b_overflow_flag |= chip.timer_b_overflow > 0 & chip.timer_b_enable;
        }
    ...
    @Override
    public void OPN2_SetChipType(/* 32 bit unsigned */ int type) {
        chip_type = type;
    }
    ...
    @Override
    public void OPN2_SetTestPin(IYm3438.IYm3438_Type chip, /* 32 bit unsigned */ int value) {
    ...
    public /* 8 bit unsigned */ int OPN2_Read(IYm3438.IYm3438_Type chip, /* 32 bit unsigned */ int port) {
        if ((port & 3) == 0 || (chip_type & ym3438_mode_readmode) > 0) {
            if (chip.mode_test_21[6] > 0) {
                ...
                chip.status = (chip.busy << 7) | ((chip.timer_b_overflow_flag ? 1 : 0) << 1)
                        | (chip.timer_a_overflow_flag ? 1 : 0);
            }
            if ((chip_type & ym3438_mode_ym2612) > 0) {
