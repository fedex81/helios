...
public class Ym3438 implements IYm3438 {
    ...
    /* exp table */
    static  /* 16 bit unsigned - [256]*/ int[] exprom = new int[]{
    ...
    /* Note table */
    static  /* 32 bit unsigned - [16]*/ int[] fn_note = new int[]{
            0, 0, 0, 0, 0, 0, 0, 1, 2, 3, 3, 3, 3, 3, 3, 3
    };

    /* Envelope generator */
    static  /* 32 bit unsigned  - [4][4]*/ int[][] eg_stephi = new int[][]{
            {0, 0, 0, 0},
            {1, 0, 0, 0},
            {1, 0, 1, 0},
            {1, 1, 1, 0}
    ...
    static  /* 8 bit unsigned - [4]*/ int[] eg_am_shift = new int[]{
            7, 3, 1, 0
    };

    /* Phase generator */
    static  /* 32 bit unsigned - [8]*/ int[] pg_detune = new int[]{16, 17, 19, 20, 22, 24, 27, 29};

    static  /* 32 bit unsigned - [8][8]*/ int[][] pg_lfo_sh1 = new int[][]{
            {7, 7, 7, 7, 7, 7, 7, 7},
            {7, 7, 7, 7, 7, 7, 7, 7},
            {7, 7, 7, 7, 7, 7, 1, 1},
            {7, 7, 7, 7, 1, 1, 1, 1},
    ...
    static  /* 32 bit unsigned - [8][8]*/ int[][] pg_lfo_sh2 = new int[][]{
            {7, 7, 7, 7, 7, 7, 7, 7},
            {7, 7, 7, 7, 2, 2, 2, 2},
            {7, 7, 7, 2, 2, 2, 7, 7},
            {7, 7, 2, 2, 7, 7, 2, 2},
    ...
    /* Address decoder */
    static  /* 32 bit unsigned  - [12]*/ int[] op_offset = new int[]{
            0x000, /* Ch1 OP1/OP2 */
            0x001, /* Ch2 OP1/OP2 */
            0x002, /* Ch3 OP1/OP2 */
            0x100, /* Ch4 OP1/OP2 */
    ...
    static  /* 32 bit unsigned - [6]*/ int[] ch_offset = new int[]{
            0x000, /* Ch1 */
            0x001, /* Ch2 */
            0x002, /* Ch3 */
            0x100, /* Ch4 */
    ...
    /* LFO */
    static  /* 32 bit unsigned - [8]*/ int[] lfo_cycles = new int[]{
            108, 77, 71, 67, 62, 44, 8, 5
    };

    /* FM algorithm */
    static  /* 32 bit unsigned - [4][6][8]  */ int[][][] fm_algorithm = new int[][][]{
            {
